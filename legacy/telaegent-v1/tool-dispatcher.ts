 ...
 */
export const NEVER_DISPATCHABLE: readonly TelaegentToolName[] = [
...
type Args<K extends TelaegentToolName> = z.infer<(typeof TOOL_ARGUMENT_SCHEMAS)[K]>;
...
async function completeTask(
  ...
  const checkpoint = await createCheckpointCommit(
    ...
    "Telaegent checkpoint: " + toSafeSummary(intentId, 60),
    ports.git,
  );
