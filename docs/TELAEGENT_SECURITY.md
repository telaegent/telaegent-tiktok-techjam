# Telaegent — security and privacy

This is the workstream #6 contribution to the submission README. It documents
what Telaegent actually protects against, what it does not, and where each claim
...
Run `npx tsx apps/server/src/telaegent/demo-evidence.ts` to see most of these
...
- secure deletion of provider-owned session files. Telaegent detaches the
