...
and a backend sweep deletes it within minutes of the 60-minute expiry when
neither person comes back to end it. Anything requiring new authority or
...
- automatic agent clarification payloads, retained only until the task ends or
  the backend sweep clears them after the 60-minute expiry
