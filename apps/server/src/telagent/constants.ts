export const TELAGENT_SCHEMA_VERSION = "telagent.v1" as const;
...
export const TELAGENT_TOOL_NAMES = [
...
export const TELAGENT_ERROR_CODES = [
  "INVALID_REQUEST",
  "POLICY_DENIED",
  "NOT_FOUND",
  "INVALID_STATE",
...
export const TELAGENT_ERROR_HTTP_STATUS = {
  INVALID_REQUEST: 400,
  POLICY_DENIED: 403,
  NOT_FOUND: 404,
  INVALID_STATE: 409,
