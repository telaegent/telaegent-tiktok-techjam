 ...
 *   1. CONTEXT_LIMITS  — TELAGENT_LIMITS is missing the two per-file byte caps
 ...
 * `plan.md` §12.3 but not in `TELAGENT_LIMITS`. Without them the isolated
...
export const CONTEXT_LIMITS = Object.freeze({
  maxApprovedRules: TELAGENT_LIMITS.approvedPathRules,
  maxSourceFiles: TELAGENT_LIMITS.sourceRefs,
  maxPackBytes: TELAGENT_LIMITS.contextPackJsonBytes,
  packTtlMs: TELAGENT_LIMITS.contextPackTtlMs,
  statusStaleAfterMs: TELAGENT_LIMITS.staleStatusMs,
  coordinationTtlMs: TELAGENT_LIMITS.coordinationTtlMs,
  maxExchanges: TELAGENT_LIMITS.maxExchangeNumber,
  maxAgentSteps: TELAGENT_LIMITS.maxAgentSteps,
  maxPublicSummaryChars: TELAGENT_LIMITS.summaryLength,
