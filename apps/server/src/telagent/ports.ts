 ...
 *
 *   1. plan.md §7.1: no Telagent component may call a runner directly, yet
 ...
 *
 * Consequence worth stating: nothing under telagent/ that #6 owns imports
...
export interface TelagentPorts {
  /**
