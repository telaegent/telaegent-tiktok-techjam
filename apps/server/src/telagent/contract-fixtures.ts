...
function envelope<TOperation extends TelagentToolName>(
  operation: TOperation,
  payload: PayloadByOperation[TOperation],
): TelagentEnvelopeBase<TOperation, PayloadByOperation[TOperation]> {
  return {
...
export const TELAGENT_ENVELOPE_FIXTURES = {
...
export const EMPTY_TELAGENT_DATABASE: TelagentDatabase = {
  projects: [],
  owners: [],
  agentBindings: [],
  conversations: [],
